...
var Font24 MatrixFont = MatrixFont{
	Data:          font24,
	Width:         17, /* Width */
	Height:        24, /* Height */
	LetterSpacing: 0,
...
// func (dev *lcdDriver) drawFont(char byte) {
// 	bytesPerRow := (dev.font.Width + 7) / 8
// 	startIndex := (int(char) - 32) * bytesPerRow * dev.font.Height
// 	for h := 0; h < dev.font.Height; h++ {
// 		y := float64(dev.cursorY + dev.lineSpacing - dev.font.Height + h)
// 		for w := 0; w < dev.font.Width; w++ {
// 			color := dev.fontBGColor
// 			isOne := dev.font.Data[startIndex+w/8]&(0b10000000>>(w%8)) != 0
// 			if isOne {
// 				color = dev.fontColor
// 			}
// 			x := float64(w + dev.cursorX)
// 			dev.Pixel(x, y, color)
// 		}
// 		startIndex += bytesPerRow
// 	}
// 	xforward := dev.font.Width + dev.font.LetterSpacing
